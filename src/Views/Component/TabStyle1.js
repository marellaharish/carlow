                    ...
                    <MDBTabs justify className='mb-3'>
                        <MDBTabsItem>
                            <MDBTabsLink onClick={() => handleJustifyClick('tab1')} active={justifyActive === 'tab1'}>
                                <MDBIcon fas icon="cube" className='me-2' />Transfer Students
                            </MDBTabsLink>
                        </MDBTabsItem>
                        <MDBTabsItem>
                            <MDBTabsLink onClick={() => handleJustifyClick('tab2')} active={justifyActive === 'tab2'}>
                                <MDBIcon far icon="sun" className='me-2' /> Military Affiliated Students
                            </MDBTabsLink>
                        </MDBTabsItem>
                        <MDBTabsItem>
                            <MDBTabsLink onClick={() => handleJustifyClick('tab3')} active={justifyActive === 'tab3'}>
                                <MDBIcon fab icon="mixcloud" className='me-2' />International Students
                            </MDBTabsLink>
                        </MDBTabsItem>
                    </MDBTabs>

...
import TabStyle2 from '../Views/TabStyle2';
                                ...
                                <div className="four-sectionAccordion">
                                    ...
                                    <MDBRow>
                                        <MDBCol size={6} >
                                            <MDBAccordion alwaysOpen  >
                                                <div className="accordion-header logo-image">
                                                    <img src={OnlineApp} className='w-50 ms-2' />
                                                </div>
                                    ...
                                    <MDBRow className="mt-4">
                                        <MDBCol>
                                            <MDBAccordion alwaysOpen>
                                                <div className="accordion-header logo-image">
                                                    <img src={User} className='w-40' /></div>
...
export default AdmissionVersion2
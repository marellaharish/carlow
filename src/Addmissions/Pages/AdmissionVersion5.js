...
import TabStyle5 from '../Views/TabStyle5';
                        ...
                        <MDBContainer fluid className="p-0">
                            ...
                            <div>
                                <MDBContainer>
                                    ...
                                    <TabStyle5 className="pb-5" />
                                </MDBContainer>
                            </div>
                        </MDBContainer>
                        <div className="application-process white pt-5">
                            <MDBContainer>
...
export default AdmissionVersion5
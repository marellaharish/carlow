                        ...
                        <div className="key-admission-section">
                            <MDBContainer>
                                <div className="four-sectionAccordion">
                                    <h2 className="EnrollmentCounselor black">How to Apply</h2>
                                    ...
                                    <MDBRow className="mt-4">
                                        <MDBCol>
                                            <MDBAccordion alwaysOpen>
                                                <div className="accordion-header logo-image"><img src={User} className='w-40' /></div>
                                    ...
                                    <MDBTabs fill className='mb-3'>
                                        ...
                                        <MDBTabsItem>
                                            <MDBTabsLink onClick={() => handleFillClick('tab2')} active={fillActive === 'tab2'}>
                                                <div className="logo-image"><img src={Master} className='w-60' /></div>
...
export default AdmissionVersion1